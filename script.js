...
console.log("1.", "The three Musketeers get", weeklyAllowance/3, "dollars each.");
// 2. How many games can Jordan buy with their cut?
console.log("2.", "Jordan can probably buy", Math.floor(49/game), "before price increase.");
...
game2 += 1;
shoes2 /= 2;
console.log("game(inflation) =",game2, "shoes(50% off) =",shoes2);
console.log("3.", "The price of games are",`${game2}`, "dollars and the shoes are now ",`${shoes2}`);
// 4. Quinn and Ricardo are twins. If they put their money together, how many on sale shoes can they buy in a month (4 weeks)?
let weeklyAllowance2 = weeklyAllowance;
weeklyAllowance2 -= 43;
weeklyAllowance2 *= 4;
weeklyAllowance2 /= shoes;
console.log("4.", "Quinn and Ricardo are able to buy",`${Math.floor(weeklyAllowance2)}`, "pairs of shoes");
// 5. How many more games can they buy if they put their money together compared to if they had bought games on their own?
weeklyAllowance2 = weeklyAllowance - 43;
let theOne = 43; //One person
theOne *= 4;
            // console.log(weeklyAllowance2);
weeklyAllowance2 *= 4;
            // console.log(weeklyAllowance2);
console.log("5.", "Together, assuming they saved for 4 months, with the price increase referenced from problem #3, they would be able to buy", Math.floor(weeklyAllowance2/game2),"games and individually only", Math.floor(theOne/game2),"games each.");
// 6. Print out the three siblings' names. "The three siblings are __, __, and ___."
console.log("6.", "The three siblings are Jordan,", "Quinn,", "Ricardo Montoya De La Rosa Ramirez.")
// 7. Use console.log() and a built-in method to count how many characters are in Ricardo's name.
 
console.log("7.","There are",sibling3.length, "characters in their name.");
// 8. Use console.log() and a built-in method to print out the string "RICARDO MONTOYA DE LA ROSA RAMIREZ"
console.log("8.","RICARDO MONTOYA DE LA ROSA RAMIREZ")
